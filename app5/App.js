...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      <Text style={{ color: 'black', fontSize: 25, marginHorizontal: 25, marginVertical: 20 }}>
        Calculadora de IMC
      </Text>
      <TextInput
        style={styles.input}
      ...
      <Text style={{ color: 'black', fontSize: 20, marginHorizontal: 70, marginVertical: 25 }}>{resultado}</Text>
    </View>
  );
}
